...
import {
  CaseImageLightbox,
  ExpandableImage,
} from "@/components/CaseImageLightbox";
...
export default function ProjectCaseLayout({
  ...
  const useLivePublishedPreview =
    shouldUsePublishedScreenPreview(project) && Boolean(project.liveUrl);
          ...
          <section className="border-y border-[#1E3654]/25 bg-[#07111F]/55 py-16 md:py-24">
            <div className="container-site">
              <SectionHeading
                ...
                description={
                  project.gallerySection?.description ??
                  "Telas e aplicações que mostram o projeto em uso."
                }
              />
