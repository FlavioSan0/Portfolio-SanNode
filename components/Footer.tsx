          ...
          <div className="flex flex-col gap-3 md:items-end">
            ...
            <div className="flex w-full flex-wrap gap-3 md:w-auto md:justify-end">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="tech-button inline-flex min-w-[132px] flex-1 items-center justify-center ...x min-w-[132px] flex-1 items-center justify-center ...items-center justify-center rounded-2xl bg-[#0B2A5B] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#2563EB]"
              >
