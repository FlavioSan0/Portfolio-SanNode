          ...
          <div className="tablet-footer-actions flex flex-col gap-3 lg:items-end">
              ...
              {footerLinks.map((item) => {
                ...
                return (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="tech-button inline-flex min-w-[132px] flex-1 items-center justify-center rounded-2xl border border-[#1E3654] bg-[#0C1B2E] px-4 py-3 text-sm font-semibold text-[#A9BDD3] transition hover:border-[#00D9FF] hover:text-[#00D9FF]"
                  >
            ...
            <div className="tablet-footer-row flex w-full flex-wrap gap-3 lg:w-auto lg:justify-end">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="tech-button inline-flex min-w-[132px] flex-1 items-center justify-center rounded-2xl bg-[#0B2A5B] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#2563EB]"
              >
